...
const CreateNewGraph: React.FC = () => {
  ...
  return (
    ...
    dark:bg-[#0c0c1c] dark:text-white relative">
      <button 
      ...
      <div className="flex justify-center items-center w-full max-sm:h-[80%] max-sm:mb-8 ">
        <form className="dark:bg-[#37373c] dark:text-white w-[80%] bg-gray-100 p-8 rounded-lg shadow-md max-sm:h-full" onSubmit={handleSubmit}>
          <div className='flex justify-center items-center max-sm:flex-col-reverse max-sm:gap-4 gap-8 w-full h-full '>
            <div className="max-sm:relative bottom-0 mb-4 max-sm:mb-0 h-[20rem] max-sm:h-[6.5rem] w-[30%] max-sm:w-full
             bg-slate-300 dark:bg-[#545457] p-4 rounded-xl flex flex-col justify-center items-center">
              <label htmlFor="fileUpload" className="text-gray-700 font-bold mb-2 dark:text-white">
                Upload Papers
              </label>
              <input
                type="file"
                id="fileUpload"
                className="w-full border rounded-lg py-2 px-3 text-gray-700 leading-tight focus:outline-none 
                focus:border-blue-500 dark:text-white dark:bg-[#4a4a4e]"
              />
            </div>
            <div className='h-[90%] w-[60%] max-sm:h-[90%] max-sm:w-full'>
              <div className="mb-4 max-sm:w-full">
              <label htmlFor="title" className="block text-gray-700 dark:text-white font-bold mb-2">
                Graph Title
              </label>
              <input
                id="title"
                ...
                className="w-full border rounded-md py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-blue-500 dark:bg-[#4a4a4e] dark:focus:border-[#a8a7a7]"
              />
            </div>
            <div className="mb-4">
              <label htmlFor="description" className="block text-gray-700 dark:text-white font-bold mb-2">
                Description
              </label>
              <textarea
                id="description"
            ...
            <div className="mb-4">
              <label htmlFor="papers" className="block text-gray-700 dark:text-white font-bold mb-2">
                Select Papers
              </label>
              <select
                id="papers"
                className="w-full border rounded-md py-2 px-3 text-gray-700 leading-tight focus:outline-none 
                focus:border-blue-500 dark:text-white dark:bg-[#4a4a4e] dark:focus:border-[#a8a7a7]"
              >
